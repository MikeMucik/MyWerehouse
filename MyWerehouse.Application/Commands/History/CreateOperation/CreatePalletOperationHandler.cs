...
{
	public class CreatePalletOperationHandler : INotificationHandler<CreatePalletOperationCommand>
	{
		...
		public async Task Handle(CreatePalletOperationCommand request, CancellationToken cancellationToken)
		{
			...
			//await _palletMovementRepo.SaveChanges();
