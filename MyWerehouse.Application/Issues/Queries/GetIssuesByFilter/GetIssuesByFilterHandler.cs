...
{
	public class GetIssuesByFilterHandler(IIssueRepo issueRepo, IMapper mapper) : IRequestHandler<GetIssuesByFilterQuery, AppResult<PagedResult<IssueDTO>>>
	{
		private readonly IIssueRepo _issueRepo = issueRepo;
		private readonly IMapper _mapper = mapper;
		public async Task<AppResult<PagedResult<IssueDTO>>> Handle(GetIssuesByFilterQuery request, CancellationToken ct)
		{
