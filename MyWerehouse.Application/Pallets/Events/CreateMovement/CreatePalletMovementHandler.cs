...
{
	public class CreatePalletMovementHandler : INotificationHandler<CreatePalletMovementNotification>
	{
		private readonly IPalletRepo _palletRepo;
		private readonly IPalletMovementRepo _palletMovementRepo;
		private readonly ILocationRepo _locationRepo;
		private readonly WerehouseDbContext _werehouseDbContext;
		public CreatePalletMovementHandler(IPalletRepo palletRepo,
