...
{
	public class UpdatePalletDTOValidator : AbstractValidator<EditPalletDTO>
	{
		public UpdatePalletDTOValidator(IValidator<ProductOnPalletDTO> productOnPalletValidator)
		{
			RuleFor(p => p.Status)
				.NotEmpty()
