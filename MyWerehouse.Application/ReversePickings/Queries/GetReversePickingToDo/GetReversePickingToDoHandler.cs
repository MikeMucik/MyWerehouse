...
{
	public class GetReversePickingToDoHandler : IRequestHandler<GetReversePickingToDoQuery, ReversePickingDetails>
	{
		...
		public async Task<ReversePickingDetails> Handle(GetReversePickingToDoQuery query, CancellationToken ct)
		{
			...
			{
				throw new NotFoundProductException($"Produkt {pickingTask.ProductId} nie ma ustawionej ilosci kartonów na paletę. Popraw produkt");
			}
			...
			var respone = new ReversePickingDetails
			{
				AddToNewPallet = true,
