...
namespace MyWerehouse.Infrastructure.Migrations
{
    ...
    [Migration("20260815095516_AddNumberCounter")]
    partial class AddNumberCounter
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyWerehouse.Domain.Common.ValueObject.NumberCounter", b =>
                {
                    b.Property<string>("Name")
                        .HasMaxLength(30)
            ...
            modelBuilder.Entity("MyWerehouse.Domain.Histories.Models.HistoryPallet", b =>
                {
                    ...
                    b.ToTable("HistoryPallet");
                });

            modelBuilder.Entity("MyWerehouse.Domain.Histories.Models.HistoryPalletDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("HistoryPalletId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("HistoryPalletId");

                    b.ToTable("HistoryPalletDetails");
                });
            ...
            modelBuilder.Entity("MyWerehouse.Domain.Inventories.Models.Inventory", b =>
                {
                    b.Property<Guid>("ProductId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MyWerehouse.Domain.Receiving.Models.Receipt", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MyWerehouse.Domain.Warehouse.Models.Location", b =>
                {
                    ...
                    b.HasIndex("Bay", "Aisle", "Position", "Height")
                        .IsUnique();
            ...
            modelBuilder.Entity("MyWerehouse.Domain.Histories.Models.HistoryPalletDetail", b =>
                {
                    b.HasOne("MyWerehouse.Domain.Histories.Models.HistoryPallet", "HistoryPallet")
                        .WithMany("HistoryPalletDetails")
                        .HasForeignKey("HistoryPalletId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("HistoryPallet");
                });
            ...
            modelBuilder.Entity("MyWerehouse.Domain.Histories.Models.HistoryReceipt", b =>
                {
                    b.HasOne("MyWerehouse.Domain.Receiving.Models.Receipt", null)
            ...
            modelBuilder.Entity("MyWerehouse.Domain.Inventories.Models.Inventory", b =>
                {
                    b.HasOne("MyWerehouse.Domain.Products.Models.Product", "Product")
                        ...
                        .HasForeignKey("MyWerehouse.Domain.Inventories.Models.Inventory", "ProductId")
            ...
            modelBuilder.Entity("MyWerehouse.Domain.Pallets.Models.Pallet", b =>
                {
                    ...
                    b.HasOne("MyWerehouse.Domain.Receiving.Models.Receipt", "Receipt")
                        .WithMany("Pallets")
                        .HasForeignKey("ReceiptId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("MyWerehouse.Domain.Histories.Models.HistoryPallet", b =>
                {
                    b.Navigation("HistoryPalletDetails");
                });
