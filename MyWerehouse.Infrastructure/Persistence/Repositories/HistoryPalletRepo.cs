...
namespace MyWerehouse.Infrastructure.Persistence.Repositories
{
	public class HistoryPalletRepo : IHistoryPalletRepo
	{
		...
		//public async Task AddHistoryPalletAsync(HistoryPallet palletMovement, CancellationToken cancellationToken)
		//{
		//	await _werehouseDbContext.HistoryPallet.AddAsync(palletMovement);
		//}
	}
}
