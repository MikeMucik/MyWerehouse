...
namespace MyWerehouse.Test.IntegrationTestRepo.PalletsTestsRepoSQLite
{
	...
	{		
		...
		//	};
		//	DbContext.Locations.AddRange(location1, location2);
		//	var pallet1 = Pallet.CreateForTests("Q1010", DateTime.UtcNow, 1, PalletStatus.Available, null, null);
		//	//var pallet1 = new Pallet
		//	//{
		//	//	PalletNumber = "Q1010",
		//	//	DateReceived = DateTime.Now,
		...
		//	//	//ReceiptId = 10,
		//	//};
		//	var pallet2 = Pallet.CreateForTests("Q1011", DateTime.UtcNow, 2, PalletStatus.ToIssue, null, null);
		//	//var pallet2 = new Pallet
		//	//{
		//	//	PalletNumber = "Q1011",
		//	//	DateReceived = DateTime.Now,
