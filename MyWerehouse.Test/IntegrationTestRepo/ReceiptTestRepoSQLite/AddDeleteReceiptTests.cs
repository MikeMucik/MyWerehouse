...
namespace MyWerehouse.Test.IntegrationTestRepo.ReceiptTestRepoSQLite
{
	public class AddDeleteReceiptTests : TestBase
	{
		...
		//	var pallet1 = Pallet.CreateForTests("Q3000", DateTime.Now, 1, PalletStatus.Available,null,null);
		...
		//	//};
		//	var pallet2 = Pallet.CreateForTests("Q3001", DateTime.Now, 2, PalletStatus.Available, null, null);
		...
		//	DbContext.SaveChanges();
		//	receipt.AttachPallet(pallet1, location1, "U0005");
		//	receipt.AttachPallet(pallet2, location2, "U0005");
		//	//Assert
