...
namespace MyWerehouse.Test.SQLiteInMemoryMode.HandlersTests.IssueTests.Integration
{
	public class IssueCreateTests : TestBase
	{
		...
		public async Task CreateIssue_AssignsFullPalletsAndAllocatesRest_WhenOneProduct()
		{
			...
			pallet3.AddProduct(product.Id, 10, DateOnly.FromDateTime(TestDates.UtcNow.AddDays(366)));
		...
		public async Task CreateIssue_AssignsFullPalletsAndAllocatesRest_WhenProductsFromTwoCategories()
		{
			...
			var pallet3 = Pallet.CreateForTests("P3", new DateTime(2025, 3, 3), 3, PalletStatus.Available, null, null);
			pallet3.AddProduct(product1.Id, 10, DateOnly.FromDateTime(TestDates.UtcNow.AddDays(365)));
