...
namespace MyWerehouse.Test.SQLiteInMemoryMode.HandlersTests.IssueTests.Integration
{
	public class IssueDeleteIntegrationServiceTests : TestBase
	{
		...
		[Fact]
		public async Task DeleteIssue_DeletesIssue_WhenStatusNew()
		{
			// Arrange
		...
		[Fact]		
		public async Task DeleteIssue_CancelsIssueAndResetsPalletsAndPickingTasks_WhenStatusPending()
		{
			// Arrange
		...
		[Fact]
		public async Task DeleteIssue_CancelsIssueAndResetsPalletsAndPickingTasks_WhenStatusNotComplete()
		{
			// Arrange
			var setup = await TestHelper.SetupBasicIssue(
				DbContext,
		...
		[Fact]
		public async Task DeleteIssue_ShouldReturnError_WhenWrongStatus()
		{
			// Arrange
			var setup = await TestHelper.SetupBasicIssue(
				DbContext,
