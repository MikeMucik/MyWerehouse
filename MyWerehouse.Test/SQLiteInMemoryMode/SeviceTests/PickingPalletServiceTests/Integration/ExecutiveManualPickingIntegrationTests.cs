...
{
	public class ExecutiveManualPickingIntegrationTests : PickingIntegrationCommandService
	{			
		...
		[Fact]
		public async Task ExecutiveManualPicking_WithIssueIdAddToOldPallet_AssignsProductAndCommits()
		{
			// Arrange
			var category = new Category
			{
		...
		[Fact]
		public async Task ExecutiveManualPicking_WithIssueIdDeleteIssue_ThrowException()
		{
			// Arrange
			var category = new Category
			{
